...
export default function BuddySection() {
  ...
  return (
    <section
      ref={coverRef}
      data-nav-bg="#fafafd"
      className="relative z-31 flex flex-col overflow-hidden bg-surface pb-24 pt-24 [--fc-cover-min-h:77vh] [--heading-reveal-offset:48px] sm:pb-36 sm:pt-36 sm:[--heading-reveal-offset:80px]"
    >
