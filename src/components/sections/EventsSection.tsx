  ...
  return (
    <div className="group w-full cursor-pointer overflow-hidden" style={style}>
      <div className="relative flex h-[220px] w-full flex-col justify-between p-[24px]">
        ...
        <div className="absolute inset-0 bg-[#edf0f7] transition-opacity duration-[400ms] group-hover:opacity-0" />
        <div
        ...
        <div className="relative z-10 flex w-full items-start justify-between">
          <div className="font-asta flex flex-col gap-[2px] text-[18px] font-medium text-[#10183d]/80">
        ...
        <p className="font-asta relative z-10 mt-[16px] text-[22px] font-semibold leading-[1.4] text-[#10183d] transition-colors duration-[400ms] group-hover:text-white">
          {title}
        </p>
      </div>
    </div>
        ...
        <div className="mx-auto w-full max-w-[1246px]">
          ...
          <Reveal delay={100}>
            <div className="relative py-[16px]">
              <div className="absolute inset-y-0 left-0 w-px bg-[#d4daed]" />
              <div className="absolute inset-y-0 left-[33.333%] w-px bg-[#d4daed]" />
              <div className="absolute inset-y-0 left-[66.666%] w-px bg-[#d4daed]" />
              <div className="absolute inset-y-0 right-0 w-px bg-[#d4daed]" />
              <div className="h-px w-full bg-[#d4daed]" />
              <div className="grid grid-cols-3">
                {EVENTS.halls.map(({ hall }) => (
                  ...
                  >
                    <p className="font-asta text-[20px] font-semibold uppercase leading-[1.4] tracking-[-0.08px] text-[#10183d]">
                      {hall}
                    </p>
                  </div>
                ))}
