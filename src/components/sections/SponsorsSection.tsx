  ...
  if (sponsor.variant === "media-partner") {
    return (
      <div className="flex flex-col items-center gap-[16px]">
        <p className="font-pretendard text-[18px] font-semibold leading-[1.4] text-[#151515]/30">
          {sponsor.label}
        </p>
        <img
          src={sponsor.src}
        ...
        <div className="w-full max-w-[1246px] overflow-hidden px-[16px] xl:px-0">
          ...
          >
            {SPONSORS_SECTION.sponsors.map((sponsor, i) => (
              <div
                key={sponsor.name}
                className="sponsor-cell flex h-[120px] items-center justify-center border-l border-t border-[#d4daed] bg-white p-[10px] md:h-[140px]"
                style={stagger[i]}
              >
